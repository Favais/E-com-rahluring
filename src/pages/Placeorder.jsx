    ...
    return (
        <div className='flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh] border-t'>
            ...
            <div className="flex flex-col gap-4 w-full sm:max-w-[480px]">
                ...
                <input className='border border-gray-300 rounded py-1.5 px-3.5 w-full' type="email" placeholder='Street Number' />
                <div className="flex gap-3">
            ...
            <div className="mt-8">
                ...
                <div className="mt-12">
                    ...
                    <div className="flex gap-3 flex-col lg:flex-row">
                        ...
                        <div onClick={() => setMethod('razor')} className="flex item-center gap-3 border p-2 px-3 cursor-pointer">
                    ...
                    <div className="w-full text-end mt-8">
                        <button onClick={() => navigate('./orders')} className='bg-black text-white px-16 py-3 text-sm rounded-sm'>PLACE ORDER</button>
                    </div>
                </div>
            </div>
        </div>
